...
enum class ChatMessageAction(val label: StringResource, val icon: ImageVector, val color: Color) {
    SAVE_SCENARIO(Res.string.save_custom_scenario_button_label, Icons.Default.Save, Color(0xFFD79921)),
    PLAY_SCENARIO(Res.string.play_custom_scenario_button_label, Icons.Default.PlayArrow, Color(0xFF98971A));
