...
data class GameSetup(
    ...
    val isSetupComplete: Boolean get() = !isOnLanguageStep && !isOnNameStep &&
            (if (isCustomSimulation) scenariosGenerationStatus == ScenarioGenerationStatus.SCENARIOS_GENERATED_ACTION
            else scenariosGenerationStatus == ScenarioGenerationStatus.SUCCESS)
